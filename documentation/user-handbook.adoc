...
with secret generation enabled, and in `generated` mode, missing generated local
secrets are created and kept in ignored local files instead of being printed.
