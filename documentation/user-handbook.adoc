...
| Pulsar | `/pulsar` or `http://localhost:8087/admin/v2/clusters` | Token-authenticated Admin API for local standalone broker; use the `platform/pulsar` Infisical item for the bearer token. No Pulsar Manager UI is bundled.
