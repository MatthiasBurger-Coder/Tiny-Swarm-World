...
| `TSW_PULSAR_TOKEN_SECRET_KEY` | generated by installer | Required | secret value | configuration contract, secret manifest, Pulsar compose |
| `TSW_PULSAR_ADMIN_TOKEN` | generated by installer | Required | secret value | configuration contract, secret manifest, Pulsar compose, browser/live tests |
| `TSW_PULSAR_MANAGER_ADMIN_PASSWORD` | generated by installer | Required | secret value | configuration contract, secret manifest, Pulsar Manager compose |
