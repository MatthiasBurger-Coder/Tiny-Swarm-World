# Workflow Slice RC1-E04: Candidate SonarCloud and container scan evidence
...
Observe a candidate-specific SonarCloud quality gate and execute the required container configuration scan with exact candidate provenance.
...
documentation:
  ...
  adr: none
stop_conditions: [Sonar result is unavailable, candidate SHA is not exact, scan tool/result is missing, quality scope is reduced, external credentials are exposed]
```
...
- `.tiny-swarm/evidence/issue-300/requirement_matrix.md`
- `.tiny-swarm/evidence/issue-300/implementation_summary.md`
- `.tiny-swarm/evidence/issue-300/changed_files.md`
- `.tiny-swarm/evidence/issue-300/test_results.md`
- `.tiny-swarm/evidence/issue-300/remaining_risks.md`
- `.tiny-swarm/evidence/issue-300/acceptance_checklist.md`
