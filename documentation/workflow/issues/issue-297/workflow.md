# Workflow Slice RC1-E01: Canonical Classic update live evidence
...
documentation:
  ...
  adr: none
stop_conditions: [missing qualified target, missing live consent, unsafe reset scope, failed preflight, raw secret or unredacted output, failed recovery]
```
...
The implementation must update the issue matrix so every mapped requirement has implementation evidence and at least one relevant test, static check, live result or external result. The following mapping is the minimum required scope: `R01-07, R01-08, R01-09, R01-10, R01-11, R01-12`.
