# Workflow Slice RC1-E06: Qualified first-user operator journey

Workflow id: `rc1-evidence-completion-20260912`
Issue: #308
Issue code: `R07`
Source: https://github.com/MatthiasBurger-Coder/Tiny-Swarm-World/issues/308
...
Execute the documented first-user journey on a qualified target and record host-specific duration, resource and readiness evidence.
...
- Requirement mapping: R07-02, R07-03, R07-04, R07-05, R07-06, R07-07, R07-08
- Affected files: README.md, documentation/manuals/, documentation/evidence/, documentation/audit/findings-register.md, documentation/arc42/11_risks_and_debt.adoc, .tiny-swarm/evidence/issue-308/
- Affected modules: operator documentation, first-user journey, browser/API acceptance
- Affected contracts: documented command semantics, live versus local status, redacted journey evidence
- Dependencies: RC1-E01, RC1-E02, RC1-E03
...
affected_files: [README.md, documentation/manuals/, documentation/evidence/, documentation/audit/findings-register.md, documentation/arc42/11_risks_and_debt.adoc, .tiny-swarm/evidence/issue-308/]
affected_modules: [operator documentation, first-user journey, browser/API acceptance]
affected_contracts: [documented command semantics, live versus local status, redacted journey evidence]
dependencies: [RC1-E01, RC1-E02, RC1-E03]
...
documentation:
  ...
  adr: none
stop_conditions: [documented command differs from executable behavior, target is not qualified, duration/resource data is inferred, browser output cannot be redacted]
```
...
The implementation must update the issue matrix so every mapped requirement has implementation evidence and at least one relevant test, static check, live result or external result. The following mapping is the minimum required scope: `R07-02, R07-03, R07-04, R07-05, R07-06, R07-07, R07-08`.

## Documentation and evidence outputs

- `.tiny-swarm/evidence/issue-308/requirement_matrix.md`
- `.tiny-swarm/evidence/issue-308/implementation_summary.md`
- `.tiny-swarm/evidence/issue-308/changed_files.md`
- `.tiny-swarm/evidence/issue-308/test_results.md`
- `.tiny-swarm/evidence/issue-308/remaining_risks.md`
- `.tiny-swarm/evidence/issue-308/acceptance_checklist.md`
