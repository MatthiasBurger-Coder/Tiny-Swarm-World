# Workflow Slice RC1-E07: Candidate image and live security boundaries
...
Capture immutable candidate image identities and verify live admin, socket, network and reachability boundaries for the Classic profile.
...
- Requirement mapping: R08-01 through R08-08
- Affected files: documentation/security/, infra/config/compose/, .tiny-swarm/evidence/issue-309/, .tiny-swarm/evidence/issue-300/
- Affected modules: image provenance, admin/socket/network boundaries, security evidence
- Affected contracts: candidate digest, security finding disposition, live reachability evidence, credential boundary
- Dependencies: RC1-E00, RC1-E04
...
affected_contracts: [candidate digest, security finding disposition, live reachability evidence, credential boundary]
dependencies: [RC1-E00, RC1-E04]
...
documentation:
  ...
  adr: none
stop_conditions: [mutable tag has no digest, admin/socket boundary is not observable, security finding is waived without disposition, raw credentials enter evidence]
```
...
The implementation must update the issue matrix so every mapped requirement has implementation evidence and at least one relevant test, static check, live result or external result. The following mapping is the minimum required scope: `R08-01 through R08-08`.

## Documentation and evidence outputs

- `.tiny-swarm/evidence/issue-309/requirement_matrix.md`
- `.tiny-swarm/evidence/issue-309/implementation_summary.md`
- `.tiny-swarm/evidence/issue-309/changed_files.md`
- `.tiny-swarm/evidence/issue-309/test_results.md`
- `.tiny-swarm/evidence/issue-309/remaining_risks.md`
- `.tiny-swarm/evidence/issue-309/acceptance_checklist.md`
