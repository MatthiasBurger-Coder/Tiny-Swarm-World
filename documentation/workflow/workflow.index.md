...
This is an indexed multi-issue workflow set. Issue #184 is currently promoted
to the active `documentation/workflow/workflow.md` on its execution branch;
#189 and #184 are locally complete, while #191 through #186 remain indexed and
require serialized promotion after each predecessor.
...
- No pull request merge, branch deletion, force-push or cleanup is part of
  workflow creation.
- Issues #189 and #184 were promoted to `documentation/workflow/workflow.md`,
  executed and independently audited locally; their context packs and issue
  evidence record the completion states.
- The promotion preserves the chain dependency and declared implementation
  branch; #191 is the next explicit promotion target.
