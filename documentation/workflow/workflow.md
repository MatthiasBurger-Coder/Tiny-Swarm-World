...
quality_gates:
  targeted: [PYTHONPATH=src python3 -m unittest tests.infrastructure.adapters.ingress.test_local_tls_contract_resolver tests.test_installer tests.infrastructure.adapters.clients.lxc.swarm.test_stack_prerequisite_registry tests.infrastructure.adapters.clients.test_lxc_swarm_runtime tests.infrastructure.test_composition, python3 tools/quality_gate.py lint, python3 tools/quality_gate.py typecheck]
  required: [python3 tools/quality_gate.py quality]
documentation:
