...
## Final execution disposition — 2026-09-13

The initial states above remain historical. E00–E09 are complete with the
issue-local final packages and R06 row audit. The repaired product is c921e695;
the final dependent-evidence integration is69f040a7. See the workflow index
completion ledger and documentation/release/rc1-decision.md. Final publication
checks and actual merged SHA are bound in the R06 PR/#294/#302 integration record.
