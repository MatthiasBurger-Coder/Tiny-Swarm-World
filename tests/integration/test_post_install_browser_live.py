...
class PostInstallConfig:
    ...
    def from_environment(cls) -> "PostInstallConfig":
        ...
        return cls(
            ...
            jenkins_url=_env_value(local_env, "TSW_JENKINS_URL", "http://localhost:11080"),
            ...
            nexus_url=_env_value(local_env, "TSW_NEXUS_URL", "http://localhost:13081"),
            ...
            portainer_url=_env_value(local_env, "TSW_PORTAINER_URL", "http://localhost:10001"),
            ...
            swagger_url=_env_value(local_env, "TSW_SWAGGER_URL", "http://localhost:16081"),
