...
class TestContainerImageContract(unittest.TestCase):
    def test_default_image_contracts_cover_setup_managed_images(self):
        ...
        self.assertEqual(contracts_by_context["portainer"].image_ref, "portainer/portainer-ce:2.45.1")
        self.assertEqual(contracts_by_context["portainer-agent"].image_ref, "portainer/agent:2.45.1")
