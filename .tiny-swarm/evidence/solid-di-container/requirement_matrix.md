...
|---|---|---|---|---|---|
| REQ-186-001 | Audit all usages of the named global container and DI decorators. | architecture/evidence | repository-wide source/test scan | complete usage inventory | OPEN |
...
| REQ-186-006 | Create the required Three-Amigos and before/after dependency map evidence. | evidence/governance | `.tiny-swarm-world/evidence/solid-di-container/` | evidence audit | OPEN |
