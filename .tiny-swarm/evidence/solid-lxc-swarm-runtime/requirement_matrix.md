...
| REQ-017 | Reduce `lxc_swarm_runtime.py` to compatibility exports or a thin facade. | Acceptance/architecture | Legacy module | Public facade/aliases exist, but non-public historical compatibility implementations remain | Boundary test excludes `_Legacy` definitions; static cleanup remains | OPEN |
